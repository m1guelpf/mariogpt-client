...
public class LifeMushroom extends MarioSprite
{
    ...
    public LifeMushroom(final boolean b, final float n, final float n2) {
        super(n, n2, SpriteType.LIFE_MUSHROOM);
        this.onGround = false;
        this.width = 4;
        this.height = 12;
        this.facing = 1;
    ...
    public MarioSprite clone() {
        final LifeMushroom lifeMushroom = new LifeMushroom(false, this.x, this.y);
